...
class TestImageGenerationPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.font_patch = patch.object(
            self.pipeline.font_manager,
            "get_font",
    ...
    def test_prepare_data_with_and_without_artwork(self):
        self.mock_feast.get_liturgical_info.return_value = {
            "season": "Test",
            "week": "Test",
            "readings": ["R1"],
        }
        ...
        with patch.object(
            self.pipeline.artwork_manager, "get_artwork_for_date"
        ) as mock_get_artwork:
            ...
            mock_get_artwork.side_effect = [
                None,
                {"cached_file": "bar.png", "name": "NextArt"},
            ]
    ...
    def test_generate_image_calls_builder(self):
        ...
        self.mock_image.get_artwork_for_date.return_value = {
            "cached_file": "foo.png",
            "name": "Art",
        }
