...
class TestReadingsManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_sunday_readings = {
            ...
            'Epiphany 1': {
                'A': ['Isaiah 61:10-62:3', 'Galatians 4:4-7', 'Luke 2:22-40', 'Psalm 148'],
                'B': ['mock'],
                'C': ['mock']
            },
            'Lent 1': {
                ...
                'C': ['Deuteronomy 26:1-11', 'Romans 10:8b-13', 'Luke 4:1-13', 'Psalm 91:1-2, 9-16']
            }
        }
        self.mock_weekday_readings = {
            ...
            'Epiphany 1': {
                'Monday': {'1': ['Epiphany 1 Monday Reading 1', 'Epiphany 1 Monday Reading 2'], '2': ['mock']}
            }
        }
        ...
        patcher1 = patch('liturgical_calendar.data.readings_data.sunday_readings', self.mock_sunday_readings)
        patcher2 = patch('liturgical_calendar.data.readings_data.weekday_readings', self.mock_weekday_readings)
        patcher3 = patch('liturgical_calendar.data.readings_data.fixed_weekday_readings', self.mock_fixed_weekday_readings)
    ...
    def test_get_readings_for_date_invalid_date(self):
        ...
        readings = self.readings_manager.get_readings_for_date("invalid-date", {})
        self.assertEqual(readings, [])
    ...
    def test_get_readings_for_date_missing_liturgical_info(self):
        ...
        readings = self.readings_manager.get_readings_for_date("2024-01-01", {"foo": "bar"})
        self.assertEqual(readings, [])
    ...
    def test_get_readings_for_date_fixed_weekday_precedence(self):
        ...
        readings = self.readings_manager.get_readings_for_date("2024-12-30", liturgical_info)  # Monday
        self.assertEqual(readings, ["1 John 2:3-11", "John 21:19-25"])
    ...
    def test_epiphany1_precedence_over_fixed_weekday_readings(self):
        ...
        readings = self.readings_manager.get_readings_for_date("2024-01-08", liturgical_info)
    ...
    def test_fixed_weekday_readings_when_epiphany1_is_late(self):
        ...
        readings = self.readings_manager.get_readings_for_date("2025-01-08", liturgical_info)
