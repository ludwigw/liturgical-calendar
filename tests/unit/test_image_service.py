...
class TestImageService(unittest.TestCase):
    ...
    def test_init_without_dependencies(self):
        ...
        with patch(
            "liturgical_calendar.services.image_service.ArtworkManager"
        ) as mock_artwork:
            with patch(
                "liturgical_calendar.services.image_service.ReadingsManager"
            ) as mock_readings:
                with patch(
                    "liturgical_calendar.services.image_service.SeasonCalculator"
                ) as mock_calc:
                    with patch(
                        "liturgical_calendar.services.image_service.FeastService"
                    ) as mock_feast:
    ...
    def test_generate_liturgical_image_success(self):
        ...
        # Mock the pipeline
        with patch(
            "liturgical_calendar.image_generation.pipeline.ImageGenerationPipeline"
        ...
        self.mock_feast_service.get_complete_feast_info.assert_called_once_with(
            "2023-04-16", False
        )
        self.mock_artwork_manager.get_artwork_for_date.assert_called_once_with(
            "2023-04-16", feast_info
        )
    ...
    def test_generate_liturgical_image_no_feast_info(self):
        ...
        self.assertIn(
            "No feast information found for date: 2023-04-16", str(context.exception)
        )
    ...
    def test_generate_liturgical_image_with_output_path(self):
        ...
        with patch(
            ...
            result = self.image_service.generate_liturgical_image(
                "2023-04-16", output_path="/tmp/test.png"
            )
    ...
    def test_generate_multiple_images_with_errors(self):
        ...
        self.mock_feast_service.get_complete_feast_info.side_effect = (
            mock_get_feast_info
        )
    ...
    def test_validate_image_data_valid(self):
        ...
        valid_data = {"name": "Easter Sunday", "season": "Easter", "colour": "white"}
    ...
    def test_get_image_generation_stats(self):
        ...
        results = [
            {"success": True, "feast_info": {"season": "Easter", "colour": "white"}},
            {"success": True, "feast_info": {"season": "Easter", "colour": "white"}},
            {"success": False, "error": "Test error"},
            {"success": True, "feast_info": {"season": "Advent", "colour": "purple"}},
        ]
