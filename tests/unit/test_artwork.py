...
class TestGetImageSourceForDate(unittest.TestCase):
    ...
    def test_multiple_feasts_cycle_selection(self):
        ...
        result_2025 = artwork_manager.get_artwork_for_date(
            "2025-01-02"
        )  # Cycle C (wraps to A)
        ...
        self.assertIn(
            result_2023["name"], ["Vedanayagam Samuel Azariah", "Seraphim of Sarov"]
        )
        self.assertIn(
            result_2024["name"], ["Vedanayagam Samuel Azariah", "Seraphim of Sarov"]
        )
    ...
    def test_martyr_flag(self):
        ...
        print(
            f"DEBUG: feasts['christmas']['02-12']: {feasts['christmas'].get('02-12')}"
        )
        self.assertIsNotNone(result)
...
class TestFeastsDataStructure(unittest.TestCase):
    ...
    def test_multiple_feasts_same_date(self):
        ...
        self.assertGreater(
            len(multi_feast_dates), 0, "Should have dates with multiple feasts"
        )
