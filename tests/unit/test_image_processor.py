...
from liturgical_calendar.exceptions import ArtworkNotFoundError, CacheError
...
class TestImageProcessor(unittest.TestCase):
    ...
    def test_download_image_failure(self, mock_get):
        ...
        with self.assertRaises(CacheError):
            self.processor.download_image("http://bad.url/image.jpg", out_path)
    ...
    def test_validate_image_failure(self):
        ...
        with self.assertRaises(ArtworkNotFoundError):
            self.processor.validate_image(bad_path)
    ...
    def test_archive_original_failure(self):
        ...
        with self.assertRaises(CacheError):
            self.processor.archive_original(orig_path, archive_dir)
