...
class ImageService:
    ...
    def generate_liturgical_image(self, date_str: str, 
                                ...
                                transferred: bool = False) -> Dict[str, Any]:
        """
    ...
    def generate_multiple_images(self, date_list: List[str], 
                               output_dir: Optional[str] = None,
                               transferred: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def _prepare_image_data(self, feast_info: Dict[str, Any], 
                           artwork_info: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def determine_color(self, result: dict, season: str, christmas_point: int, advent_sunday: int) -> str:
        """
    ...
    def get_artwork_for_date(self, date_str: str, feast_info: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
