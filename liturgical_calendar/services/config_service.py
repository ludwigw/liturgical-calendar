...
class ConfigService:
    ...
    def get_output_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'filename_format': self.get('output.filename_format', 'liturgical_{date}.png'),
    ...
    def get_logging_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'max_file_size': self.get('logging.max_file_size', 10 * 1024 * 1024),  # 10MB
