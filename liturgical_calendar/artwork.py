...
feasts = {
    ...
    'easter': {
        ...
        -7: [ { 'name': 'Palm Sunday', 'source': 'https://www.instagram.com/p/DIYYTfuB4k-/' } ],
        ...
        -4: [ { 'name': 'Holy Wednesday', 'source': 'https://www.instagram.com/p/DIgGtsgOzz7/' } ],
        -3: [ { 'name': 'Maundy Thursday', 'source': 'https://www.instagram.com/p/DIiyb2AO1Gz/' } ],
        -2: [ { 'name': 'Good Friday', 'source': 'https://www.instagram.com/p/DImpmhROac5/' } ],
        -1: [ { 'name': 'Holy Saturday', 'source': 'https://www.instagram.com/p/DIn7-VXusAH/' } ],
    ...
    'christmas': {
        ...
        '01-02': [
            { 'name': 'Vedanayagam Samuel Azariah', 'url': 'https://en.wikipedia.org/wiki/Vedanayagam_Samuel_Azariah', 'source': 'https://www.instagram.com/p/DEUhxUauwoG/' },
            { 'name': 'Seraphim of Sarov', 'url': 'https://en.wikipedia.org/wiki/Seraphim_of_Sarov', 'source': 'https://www.instagram.com/p/DEaBZJYuTkc/' }
        ],
        ...
        '01-13': [
            ...
            { 'name': 'Mungo', 'url': 'https://en.wikipedia.org/wiki/Saint_Mungo', 'source': 'https://www.instagram.com/p/DEzbZgNuBQO/' }
        ],
        ...
        '01-30': [
            { 'name': 'Leslie Newbigin', 'url': 'https://en.wikipedia.org/wiki/Lesslie_Newbigin', 'source': 'https://www.instagram.com/p/DFaDOtKOtEs/' },
            { 'name': 'Charles, king and martyr', 'source': 'https://www.instagram.com/p/DFcoGi2uKQi/' }
        ],
        ...
        '02-21': [
            { 'name': 'Billy Graham', 'url': 'https://en.wikipedia.org/wiki/Billy_Graham', 'source': 'https://www.instagram.com/p/DGVRi6MujzN/'},
            { 'name': 'Eric Lidell', 'url': 'https://en.wikipedia.org/wiki/Eric_Liddell', 'source': 'https://www.instagram.com/p/DGX2UWKBAa8/'},
            ],
        ...
        '03-07': [
            { 'name': 'Paul Cuffee', 'url': 'https://en.wikipedia.org/wiki/Paul_Cuffee_(missionary)', 'source': 'https://www.instagram.com/p/DGyH3aGpo4j/' },
            { 'name': 'Perpetua, Felicity and companions', 'source': 'https://www.instagram.com/p/DG5NyJtuLL6/' }
        ],
        '03-08': [
            { 'name': 'Edward King', 'url': 'https://en.wikipedia.org/wiki/Edward_King_(English_bishop)', 'prec':4, 'readings': ['Hebrews 13:1-8'] },
            { 'name': 'Felix of Burgundy', 'url': 'https://en.wikipedia.org/wiki/Felix_of_Burgundy', 'source': 'https://www.instagram.com/p/DG75f2MhtFK/' }
        ],
        '03-09': [
            { 'name': 'Robert Machray', 'url': 'https://en.wikipedia.org/wiki/Robert_Machray_(bishop)', 'source': 'https://www.instagram.com/p/DHCWejMOtMy/' },
            { 'name': 'Maqhamusela Khanyile', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Maqhamusela_Khanyile', 'source': 'https://www.instagram.com/p/DG9E9FVBHYi/' }
        ],
        ...
        '03-24': [
            { 'name': 'Walter Hilton of Thurgarton', 'url': 'https://en.wikipedia.org/wiki/Walter_Hilton', 'prec':3 },
            { 'name': 'Óscar Romero', 'url': 'https://en.wikipedia.org/wiki/Óscar_Romero', 'source': 'https://www.instagram.com/p/C43upVCOY05/' }
        ],
        ...
        '04-02': [
            ...
            { 'name': 'Sakachuwescum', 'url': 'https://en.wikipedia.org/wiki/Henry_Budd', 'source': 'https://www.instagram.com/p/C5QjoK-u8bm/' }
        ],
        ...
        '04-23': [
            ...
            { 'name': 'Michael Ramsay', 'url': 'https://en.wikipedia.org/wiki/Michael_Ramsey', 'source': 'https://www.instagram.com/p/C6JRaHaO4Rg/' }
        ],
        ...
        '05-09': [
            { 'name': 'Pachomius the Great', 'url': 'https://en.wikipedia.org/wiki/Pachomius_the_Great', 'source': 'https://www.instagram.com/p/C6_SZOgOKbP/' },
            { 'name': 'Gregory the Theologian', 'url': 'https://en.wikipedia.org/wiki/Gregory_of_Nazianzus', 'source': 'https://www.instagram.com/p/C6yTRucOB-p/' },
            { 'name': 'Nikolaus Ludwig von Zinzendorf', 'url': 'https://en.wikipedia.org/wiki/Nicolaus_Zinzendorf', 'source': 'https://www.instagram.com/p/C6y6nVFOvzq/' }
        ],
        ...
        '05-24': [
            { 'name': 'John and Charles Wesley', 'source': 'https://www.instagram.com/p/DGvTqkTOuP5/' },
            { 'name': 'Jackson Kemper', 'url': 'https://en.wikipedia.org/wiki/Jackson_Kemper', 'source': 'https://www.instagram.com/p/C7WdJMUOVQB/' },
            { 'name': 'Vincent of Lérins', 'url': 'https://en.wikipedia.org/wiki/Vincent_of_Lérins', 'source': 'https://www.instagram.com/p/C7PgifHvLcv/' }
        ],
        '05-25': [ { 'name': 'The Venerable Bede', 'source': 'https://www.instagram.com/p/C7Y-VDaOEMd/' } ],
        '05-26': [
            { 'name': 'Augustine of Canterbury', 'source': 'https://www.instagram.com/p/C7Z6AG1OWHy/' },
            { 'name': 'John Calvin', 'url': 'https://en.wikipedia.org/wiki/John_Calvin', 'source': 'https://www.instagram.com/p/C7eAv7vutcP/' }
        ],
        '05-28': [ { 'name': 'Lanfranc', 'url': 'https://en.wikipedia.org/wiki/Lanfranc', 'prec':3 } ],
        '05-30': [
            { 'name': 'Josephine Butler', 'source': 'https://www.instagram.com/p/C7l3MIdO0D6/' },
            { 'name': 'Joan of Arc', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Joan_of_Arc', 'source': 'https://www.instagram.com/p/C7gpAXZOmcp/' }
        ],
        ...
        '06-01': [
            ...
            { 'name': 'Nicomedes', 'martyr': 1, 'url': 'https://www.instagram.com/p/C75aCiJMiOg/', 'source': 'https://www.instagram.com/p/C75aCiJMiOg/'}
        ],
        ...
        '06-04': [
            { 'name': 'Petroc', 'url': 'https://en.wikipedia.org/wiki/Saint_Petroc', 'prec':3},
            { 'name': 'John XXIII', 'url': 'https://en.wikipedia.org/wiki/Pope_John_XXIII', 'source': 'https://www.instagram.com/p/C7zBfUVO0F1/'}
        ],
        ...
        '06-14': [
            { 'name': 'Richard Baxter', 'source': 'https://www.instagram.com/p/DDTJSdHMEwV/'},
            { 'name': 'Gilbert Keith Chesterton', 'url': 'https://en.wikipedia.org/wiki/G._K._Chesterton', 'source': 'https://www.instagram.com/p/C8URscFOjou/'},
            { 'name': 'Basil the Great', 'url': 'https://en.wikipedia.org/wiki/Basil_of_Caesarea', 'source': 'https://www.instagram.com/p/C8MakrWOAwo/'}
        ],
        ...
        '06-29': [
            { 'name': 'Peter and Paul, Apostles', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Saint_Peter', 'source': 'https://www.instagram.com/p/C8zK37uOFU2/' },
            { 'name': 'Samuel Ajayi Crowther', 'url': 'https://en.wikipedia.org/wiki/Samuel_Ajayi_Crowther', 'source': 'https://www.instagram.com/p/C8fJee3J1xc/' }
        ],
        ...
        '07-06': [
            { 'name': 'Thomas More and John Fisher', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Thomas_More', 'source': 'https://www.instagram.com/p/C9FB1VuOCDl/'},
            { 'name': 'Jan Hus', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Jan_Hus', 'source': 'https://www.instagram.com/p/C9F76BIO6cY/'}
        ],
        ...
        '07-15': [
            ...
            { 'name': 'Bonaventure', 'url': 'https://en.wikipedia.org/wiki/Bonaventure', 'source': 'https://www.instagram.com/p/C9YEJVVhC2b/' },
            { 'name': 'St Olga and St Vladimir', 'url': 'https://en.wikipedia.org/wiki/Vladimir_the_Great', 'source': 'https://www.instagram.com/p/C9cYHsruqVq/' }
        ],
        ...
        '07-19': [
            { 'name': 'Gregory, and his sister Macrina', 'url': 'https://en.wikipedia.org/wiki/Gregory_of_Nyssa', 'source': 'https://www.instagram.com/p/C9nP1j7OpU_/' },
            { 'name': 'Macrina', 'url': 'https://en.wikipedia.org/wiki/Macrina_the_Younger', 'source': 'https://www.instagram.com/p/C9kDOMwuFAQ/' }
        ],
        ...
        '07-25': [
            { 'name': 'Christopher', 'martyr': 1, 'url': 'https://en.wikipedia.org/wiki/Saint_Christopher', 'source': 'https://www.instagram.com/p/C9svUIqOzCI/' },
            { 'name': 'James the Apostle', 'url': 'https://en.wikipedia.org/wiki/James,_son_of_Zebedee', 'source': 'https://www.instagram.com/p/C92LnIWuGt2/' }
        ],
        ...
        '07-27': [
            { 'name': 'Brooke Foss Westcott', 'url': 'https://en.wikipedia.org/wiki/Brooke_Foss_Westcott', 'prec':3},
            { 'name': 'William Reed Huntington', 'url': 'https://en.wikipedia.org/wiki/William_Reed_Huntington', 'source': 'https://www.instagram.com/p/C97f_s-OiOg/'}
        ],
        ...
        '08-09': [
            { 'name': 'Mary Sumner', 'url': 'https://en.wikipedia.org/wiki/Mary_Sumner', 'source': 'https://www.instagram.com/p/C-coZ74OiQC/' },
            { 'name': 'Edith Stein', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Edith_Stein', 'source': 'https://www.instagram.com/p/C-udwOnOQBk/' }
        ],
        ...
        '08-14': [
            { 'name': 'Maximilian Kolbe', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Maximilian_Kolbe', 'source': 'https://www.instagram.com/p/C-xQ8GpuSR8/'},
            { 'name': 'Jonathan Myrick Daniels', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Jonathan_Myrick_Daniels', 'source': 'https://www.instagram.com/p/C-7jf6fO_wo/'}
        ],
        ...
        '08-27': [
            { 'name': 'Monica', 'url': 'https://en.wikipedia.org/wiki/Monica_of_Hippo', 'source': 'https://www.instagram.com/p/C_LF_BrOJWY/' },
            { 'name': 'Simeon Bachos', 'url': 'https://en.wikipedia.org/wiki/Ethiopian_eunuch', 'source': 'https://www.instagram.com/p/C_G86kWS_rn/'}
        ],
        ...
        '08-30': [
            { 'name': 'John Bunyan', 'url': 'https://en.wikipedia.org/wiki/John_Bunyan', 'source': 'https://www.instagram.com/p/C_dMqaXuDs8/' },
            { 'name': 'Charles Chapman Grafton', 'url': 'https://en.wikipedia.org/wiki/Charles_Chapman_Grafton', 'source': 'https://www.instagram.com/p/C_SjjfpO-PZ/' }
        ],
        '08-31': [
            { 'name': 'Aidan', 'url': 'https://en.wikipedia.org/wiki/Aidan_of_Lindisfarne', 'source': 'https://www.instagram.com/p/C_Wav_iOSSo/' },
            { 'name': 'Joseph of Arimathea', 'url': 'https://en.wikipedia.org/wiki/Joseph_of_Arimathea', 'source': 'https://www.instagram.com/p/C-IRmZ0uNW_/' }
        ],
        ...
        '09-06': [
            { 'name': 'Allen Gardiner', 'url': 'https://en.wikipedia.org/wiki/Allen_Gardiner', 'prec':3},
            { 'name': 'Hannah More', 'url': 'https://en.wikipedia.org/wiki/Hannah_More', 'source': 'https://www.instagram.com/p/C_ni3-NuGp1/'}
        ],
        ...
        '09-09': [
            { 'name': 'Charles Fuge Lowder', 'url': 'https://en.wikipedia.org/wiki/Charles_Fuge_Lowder', 'prec':3},
            { 'name': 'Constance and Her Companions', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/St._Mary%27s_Episcopal_Cathedral_(Memphis,_Tennessee)', 'source': 'https://www.instagram.com/p/C_sRKc3Oij0/'}
        ],
        ...
        '09-16': [
            { 'name': 'Ninian', 'url': 'https://en.wikipedia.org/wiki/Saint_Ninian', 'source': 'https://www.instagram.com/p/C_-mdf9uWcI/' },
            { 'name': 'Edward Bouverie Pusey', 'url': 'https://en.wikipedia.org/wiki/Edward_Bouverie_Pusey', 'source': 'https://www.instagram.com/p/DACJbuIBSFP/'}
        ],
        ...
        '09-20': [
            { 'name': 'John Coleridge Patteson and companions', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/John_Coleridge_Patteson', 'source': 'https://www.instagram.com/p/DAI8hwyOHnB/' },
            { 'name': 'Andrew Kim Taegon', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Andrew_Kim_Taegon', 'source': 'https://www.instagram.com/p/C7jW99EOmfT/' }
        ],
        ...
        '09-25': [
            { 'name': 'Lancelot Andrewes', 'url': 'https://en.wikipedia.org/wiki/Lancelot_Andrewes', 'source': 'https://www.instagram.com/p/DAYhUEBOLtM/' },
            { 'name': 'Sergius of Radonezh', 'url': 'https://en.wikipedia.org/wiki/Serge_of_Radonezh', 'source': 'https://www.instagram.com/p/DAVhlDNOWJQ/'}
        ],
        ...
        '10-01': [
            { 'name': 'Thérèse of Lisieux', 'url': 'https://en.wikipedia.org/wiki/Therese_of_Lisieux', 'source': 'https://www.instagram.com/p/DBKJ0H6h76c/' },
            { 'name': 'Remigius', 'url': 'https://en.wikipedia.org/wiki/Saint_Remigius', 'source': 'https://www.instagram.com/p/DAlVMZvujVZ/'},
            { 'name': 'Anthony Ashley Cooper', 'url': 'https://en.wikipedia.org/wiki/Anthony_Ashley-Cooper,_7th_Earl_of_Shaftesbury', 'source': 'https://www.instagram.com/p/DAdjWyYuViy/' }
        ],
        ...
        '10-11': [
            { 'name': 'Ethelburga', 'url': 'https://en.wikipedia.org/wiki/Ethelburga_of_Barking', 'prec':3},
            { 'name': 'Philip the Deacon', 'url': 'https://en.wikipedia.org/wiki/Philip_the_Evangelist', 'source': 'https://www.instagram.com/p/DA_BZe9uq4k/' }
        ],
        '10-12': [
            { 'name': 'Wilfrid', 'url': 'https://en.wikipedia.org/wiki/Wilfrid', 'prec':4, 'readings': ['Luke 5:1-11', '1 Corinthians 1:18-25'] },
            { 'name': 'Cecil Frances Alexander', 'url': 'https://en.wikipedia.org/wiki/Cecil_Frances_Alexander', 'source': 'https://www.instagram.com/p/DBBozi-OZq9/'}
        ],
        ...
        '10-15': [
            { 'name': 'Samuel Isaac Joseph Schereschewsky', 'url': 'https://en.wikipedia.org/wiki/Samuel_Schereschewsky', 'source': 'https://www.instagram.com/p/DBGhc1ou0vz/'},
            { 'name': 'Teresa of Avila', 'url': 'https://en.wikipedia.org/wiki/Teresa_of_%C3%81vila', 'source': 'https://www.instagram.com/p/DBJPCOmO0gy/' }
        ],
        ...
        '10-31': [
            { 'name': 'Martin Luther', 'source': 'https://www.instagram.com/p/DGNjM5juUmt/' },
            { 'name': 'All Hallows Eve', 'source': 'https://www.instagram.com/p/DByGCxxBSZV/' }
        ],
        ...
        '11-03': [
            { 'name': 'Richard Hooker', 'url': 'https://en.wikipedia.org/wiki/Richard_Hooker', 'prec':4, 'readings': ['John 16:12-15', 'Ecclesiasticus 44:10-15'], 'source': 'https://www.instagram.com/p/DB4n6E_hAJA/' },
            { 'name': 'Martin of Porres', 'url': 'https://en.wikipedia.org/wiki/Saint_Martin_de_Porres', 'source': 'https://www.instagram.com/p/DB7Rn0NBtLB/'}
        ],
        '11-06': [
            { 'name': 'Leonard', 'url': 'https://en.wikipedia.org/wiki/Leonard_of_Noblac', 'prec':3},
            { 'name': 'William Temple', 'url': 'https://en.wikipedia.org/wiki/William_Temple_(archbishop)', 'source': 'https://www.instagram.com/p/DCBpm8MOLwI/' }
        ],
        ...
        '11-22': [
            { 'name': 'Cecilia', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Cecilia_(saint)', 'prec':3, 'source': 'https://www.instagram.com/p/DCrs-pLvjcm/'},
            { 'name': 'C.S. Lewis', 'url': 'https://en.wikipedia.org/wiki/C._S._Lewis', 'source': 'https://www.instagram.com/p/DC72rGlOxE2/' }
        ],
        ...
        '11-25': [
            { 'name': 'Catherine', 'martyr':1, 'url': 'https://en.wikipedia.org/wiki/Catherine_of_Alexandria', 'prec':3, 'source': 'https://www.instagram.com/p/DCxjbPrus8E/'},
            { 'name': 'Isaac Watts', 'url': 'https://en.wikipedia.org/wiki/Isaac_Watts', 'source': 'https://www.instagram.com/p/DC38BELuRBg/'}
        ],
        ...
        '12-04': [
            { 'name': 'John of Damascus', 'source': 'https://www.instagram.com/p/DDKH_XxxyOR/'},
            { 'name': 'Nicholas Ferrar', 'url': 'https://en.wikipedia.org/wiki/Nicholas_Ferrar', 'source': 'https://www.instagram.com/p/DDOGOb_OxIU/'},
            { 'name': 'Clement of Alexandria', 'url': 'https://en.wikipedia.org/wiki/Clement_of_Alexandria', 'source': 'https://www.instagram.com/p/DDMrL3GuG4c/'}
        ],
        ...
        '12-13': [
            { 'name': 'Samuel Johnson', 'url': 'https://en.wikipedia.org/wiki/Samuel_Johnson', 'source': 'https://www.instagram.com/p/DDpHHQ6OUOm/'},
        ...
        '12-28': [
            { 'name': 'The Holy Family', 'url': 'https://en.wikipedia.org/wiki/Holy_Family', 'source': 'https://www.instagram.com/p/DENOTZOOYPN/'},
            { 'name': 'The Holy Innocents', 'source': 'https://www.instagram.com/p/DEHwrMWOTHK/'}
        ],
...
def lookup_feast_artwork(relative_to, pointer, cycle_index=0):
    ...
    """
    feast_list = feasts[relative_to].get(pointer)
    if not feast_list:
        return None
...
def get_image_source_for_date(date_str, liturgical_result=None):
    """
