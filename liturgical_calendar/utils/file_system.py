...
def check_disk_space(directory: Union[str, Path], required_bytes: int, 
                    min_free_mb: int = 10) -> bool:
    """
    ...
    try:
        ...
        if usage.free < min_free_bytes:
            msg = (f"Insufficient disk space in {directory}: "
...
def safe_save_image(image, file_path: Union[str, Path], 
                   quality: int = 95, 
