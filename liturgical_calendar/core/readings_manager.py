...
class ReadingsManager:
    ...
    def get_weekday_readings(
        self, weekday_reading: str, day_of_week: str, cycle: int
    ) -> List[str]:
        """
        ...
        """
        return (
            self.weekday_readings.get(weekday_reading, {})
            .get(day_of_week, {})
            .get(str(cycle), [])
        )
        ...
        try:
            ...
            if date.weekday() == 6:  # Sunday is represented by 6
                ...
                if weekday_reading:
                    ...
                    week_based_readings = self.get_weekday_readings(
                ...
                fixed_readings = self.get_fixed_weekday_readings(
